...
export default function Home() {
  ...
  // Server-side aur client-side dono ke liye same HTML generate karein
        ...
        <div className="demo-card">
          ...
          <div className="theme-info-code">
            {isMounted && isInitialized ? (
              ...
              <>
                <div>Primary: Loading...</div>
                <div>Background: Loading...</div>
                <div>Surface: Loading...</div>
                <div>Text Primary: Loading...</div>
              </>
            )}
          </div>
        </div>
